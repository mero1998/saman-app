          ...
          builder: (CartGetxController controller) {
            ...
            Center(
              child: Column(children: [
                Icon(Icons.shopping_cart_outlined, color: kPrimaryColor, size: 70,),
                Text("لا يوجد منتجات بالسلة", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, fontFamily: "Cairo", color:kPrimaryColor ),)
              ],),
            ) :
            Column(
